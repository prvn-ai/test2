...
- GitHub Username: `prvn-ai`
- Repository: `prvn-ai/test2`

## How the Integration Was Established

1. Connected the GitHub account to ChatGPT using the GitHub connector.
2. Authorized ChatGPT to access repositories available under the connected GitHub account.
